      ...
      <div className="mt-2 space-y-8 rounded-2xl border border-slate-200 bg-white p-6 text-sm leading-relaxed text-slate-800 shadow-sm">
        ...
        <section className="space-y-3">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-slate-200 text-xs sm:text-sm">
              <thead className="bg-slate-50">
                <tr>
                  <th className="border-b border-slate-200 px-3 py-2 text-left font-semibold">Plan</th>
                  ...
                  <th className="border-b border-slate-200 px-3 py-2 text-left font-semibold">Features</th>
